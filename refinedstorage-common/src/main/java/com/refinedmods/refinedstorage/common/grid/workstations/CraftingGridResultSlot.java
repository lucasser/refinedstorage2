...
public class CraftingGridResultSlot extends AbstractGridResultSlot {

    private final CraftingCraftingMatrix inputMatrix;

    CraftingGridResultSlot(final Player player, final CraftingCraftingMatrix matrix,
    ...
    @Override
    protected CraftingCraftingMatrix getInputMatrix() {
        return inputMatrix;
    }
}
